  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        console.log('📦 Products raw:', pRes.data);
        console.log('🏢 Departments raw:', dRes.data);
        ...
        const departmentsData = Array.isArray(dRes.data)
          ? dRes.data
        ...
        setError(
          ...
          err.response?.data ||
          'Failed to load products/departments. Is the backend running?'
        );
      }
    };
