...
//           // ✅ Already spread from prod, but explicitly surfaced for clarity:
...
//       columnStyles: {
//         0:  { cellWidth: 62, halign: 'left', fontStyle: 'bold' },  // Product Name
//         1:  { cellWidth: 80, halign: 'left' },                      // Description
//         2:  { cellWidth: 28, halign: 'center' },                    // Qty
//         3:  { cellWidth: 60, halign: 'left' },                      // Department
//         4:  { cellWidth: 60, halign: 'left' },                      // Supplier
//         5:  { cellWidth: 65, halign: 'left' },                      // Receipt Voucher No
//         6:  { cellWidth: 45, halign: 'right' },                     // Price
//         7:  { cellWidth: 45, halign: 'right' },                     // Balance
//         8:  { cellWidth: 55, halign: 'center' },                    // Receipt Date
//         9:  { cellWidth: 55, halign: 'center' },                    // Issue Date
//         10: { cellWidth: 80, halign: 'left' },                      // Staff Description
//         11: { cellWidth: 80, halign: 'left' },                      // Admin Note
//         12: { cellWidth: 55, halign: 'center' },                    // Admin Status
//         13: { cellWidth: 50, halign: 'center' }                     // Stock Status
//       },
//       margin: { left: marginLeft, right: marginRight },
//       didParseCell: (data) => {
...
//       <h2>Product Inventory & Request Report</h2>
...
//                   <th style={headerStyle}>ataffRequestQuantity</th>
//                   <th style={headerStyle}>Department</th>
//                   <th style={headerStyle}>Supplier</th>
//                   <th style={headerStyle}>Receipt Voucher No</th>
...
//         return {
//           ...prod,
//           // ✅ From product table (real stock)
//           productQuantity: prod.productQuantity ?? '0',
//           // ✅ From request (what staff asked for)
...
//         2:  { cellWidth: 35, halign: 'center' },                    // Product Qty
//         3:  { cellWidth: 40, halign: 'center' },                    // Staff Request Qty
//         4:  { cellWidth: 55, halign: 'left' },                      // Department
//         5:  { cellWidth: 55, halign: 'left' },                      // Supplier
//         6:  { cellWidth: 60, halign: 'left' },                      // Receipt Voucher No
//         7:  { cellWidth: 40, halign: 'right' },                     // Price
//         8:  { cellWidth: 40, halign: 'right' },                     // Balance
//         9:  { cellWidth: 50, halign: 'center' },                    // Receipt Date
//         10: { cellWidth: 50, halign: 'center' },                    // Issue Date
//         11: { cellWidth: 70, halign: 'left' },                      // Staff Description
//         12: { cellWidth: 70, halign: 'left' },                      // Admin Note
//         13: { cellWidth: 50, halign: 'center' },                    // Admin Status
//         14: { cellWidth: 45, halign: 'center' }                     // Stock Status
//       },
//       margin: { left: marginLeft, right: marginRight },
//       didParseCell: (data) => {
//         if (data.section === 'body') {
...
//                   <th style={headerStyle}>Product Name</th>
//                   <th style={headerStyle}>Product Description</th>
//                   <th style={headerStyle}>Product Quantity</th>
//                   <th style={headerStyle}>Staff Request Quantity</th>
//                   <th style={headerStyle}>Department</th>
//                   <th style={headerStyle}>Supplier</th>
//                   <th style={headerStyle}>Receipt Voucher No</th>
//                   <th style={headerStyle}>Price</th>
...
//                       <td style={cellStyle}>{p.productName || '-'}</td>
//                       <td style={cellStyle}>{p.productDescription ?? '-'}</td>
//                       {/* ✅ Product quantity from product table */}
//                       <td style={{ ...cellStyle, fontWeight: '600', color: '#1e40af' }}>
//                         {p.productQuantity ?? '0'}
//                       </td>
//                       {/* ✅ Staff request quantity */}
//                       <td style={cellStyle}>{p.requestQuantity ?? '-'}</td>
//                       <td style={cellStyle}>{p.departmentName}</td>
//                       <td style={cellStyle}>{p.supplierName ?? '-'}</td>
//                       <td style={cellStyle}>{p.receiptVoucherNo ?? '-'}</td>
//                       <td style={cellStyle}>
...
//           flexDirection: 'column',
//         }}>
//           {/* Scrollable table wrapper — table now fits screen width */}
//           <div style={{
//             flex: 1,
//             minHeight: 0,
//             overflow: 'auto',
...
//               tableLayout: 'fixed',   /* ✅ Columns share available width */
//               fontSize: '12px'
//             }}>
//               {/* ✅ Fixed column widths that sum to 100% */}
//               <colgroup>
//                 <col style={{ width: '11%' }} />
//                 <col style={{ width: '12%' }} />
//                 <col style={{ width: '6%' }} />
...
//               <thead>
//                 <tr>
//                   <th style={{ ...headerStyle, position: 'sticky', top: 0, zIndex: 2 }}>Product</th>
//                   <th style={{ ...headerStyle, position: 'sticky', top: 0, zIndex: 2 }}>Description</th>
//                   <th style={{ ...headerStyle, position: 'sticky', top: 0, zIndex: 2 }}>Qty</th>
...
//                   <th style={{ ...headerStyle, position: 'sticky', top: 0, zIndex: 2 }}>Receipt</th>
//                   <th style={{ ...headerStyle, position: 'sticky', top: 0, zIndex: 2 }}>Issue</th>
...
//                   <th style={{ ...headerStyle, position: 'sticky', top: 0, zIndex: 2 }}>Stock</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {paginatedProducts.length === 0 ? (
...
//                   paginatedProducts.map((p) => (
//                     <tr key={p.productId} style={{ borderBottom: '1px solid #e2e8f0' }}>
//                       <td style={truncatedCellStyle} title={p.productName}>{p.productName || '-'}</td>
//                       <td style={truncatedCellStyle} title={p.productDescription}>{p.productDescription ?? '-'}</td>
//                       <td style={{ ...cellStyle, fontWeight: '600', color: '#1e40af', textAlign: 'center' }}>
//                         {p.productQuantity ?? '0'}
//                       </td>
//                       <td style={{ ...cellStyle, textAlign: 'center' }}>{p.requestQuantity ?? '-'}</td>
//                       <td style={truncatedCellStyle} title={p.departmentName}>{p.departmentName}</td>
//                       <td style={truncatedCellStyle} title={p.supplierName}>{p.supplierName ?? '-'}</td>
//                       <td style={truncatedCellStyle} title={p.receiptVoucherNo}>{p.receiptVoucherNo ?? '-'}</td>
...
//                       <td style={truncatedCellStyle} title={p.description}>{p.description ?? '-'}</td>
//                       <td style={truncatedCellStyle} title={p.adminNote}>{p.adminNote ?? '-'}</td>
...
// /* ✅ For cells that may contain long text — truncate with ellipsis + tooltip */
