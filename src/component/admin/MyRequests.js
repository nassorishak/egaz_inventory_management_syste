...
//   // ===== Give product to staff (complete request) =====
//   const completeRequest = async (id) => {
//     if (!window.confirm('Give this product to the staff? Stock will be reduced.')) {
//       return;
//     }
//     setActionLoading(id);
//     setError('');
...
//     navigate('/admin-request-product');
//   };
...
//         }
//         .mar-stat .value {
//           font-size: 26px; font-weight: 800; color: #172033; margin-top: 6px;
//         }
...
//         .mar-loading {
//           text-align: center; padding: 50px 20px; color: #64748b; font-size: 14px;
//         }
...
//               <p>Give approved products to staff and manage contracts.</p>
//             </div>
